...
//section部分
//限制条件栏
for(i=0;i<$('.condition li').length-1;i++){
$('.condition li').eq(i).click(function(){
	$(this).addClass('selcurrent').siblings().removeClass('selcurrent')
})
}
$('.condition li').eq(3).click(function(){
	$('.condition .ensure').stop().show()
})
$('.condition .ensure').click(function(){
	$('.condition .ensure').stop().hide()
})

$('.condition li').eq(0).click(function(){
	$('.condition .ensure').stop().hide();
	$(this).children().eq(2).children().stop().show();
	$(this).siblings().children().children().stop().hide();
})
...
$('.condition li').eq(0).children().eq(2).children().hover(function(){
	$(this).stop().hide();
	$('.condition li').eq(0).children().eq(1).children().stop().show();
},function(){
	$('.condition li').eq(0).children().eq(1).children().stop().hide();
	$(this).stop().show();
})

//$('.condition li').eq(1).children().eq(2).children().hover(function(){
//	$(this).stop().hide();
//	$('.condition li').eq(1).children().eq(1).children().stop().show();
//},function(){
//	$('.condition li').eq(1).children().eq(1).children().stop().hide();
//	$(this).stop().show();
//})
//
//$('.condition li').eq(2).children().eq(2).children().hover(function(){
//	$(this).stop().hide();
//	$('.condition li').eq(2).children().eq(1).children().stop().show();
//},function(){
//	$('.condition li').eq(2).children().eq(1).children().stop().hide();
//	$(this).stop().show();
//})
...
//跳转详情页
$('.smallgoods img').eq(0).click(function(){
	window,location.href='detailpage.html'
})
$('.smallgoods .goodsname').eq(0).click(function(){
	window,location.href='detailpage.html'
})
