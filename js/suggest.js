...
$('.smallgoods img').eq(0).mouseenter(function(){
	$('.smallgoods .sousuo').eq(0).stop().fadeIn(200)

	$('.smallgoods .sousuo').eq(0).mouseenter(function(){
		$('.smallgoods .sousuo').eq(0).stop().show()
	})
})
$('.smallgoods img').eq(0).mouseleave(function(){
	$('.smallgoods .sousuo').eq(0).stop().fadeOut(200)
})

$('.smallgoods img').eq(1).mouseenter(function(){
	$('.smallgoods .sousuo').eq(1).stop().fadeIn(200)

	$('.smallgoods .sousuo').eq(1).mouseenter(function(){
		$('.smallgoods .sousuo').eq(1).stop().show()
	})
})
$('.smallgoods img').eq(1).mouseleave(function(){
	$('.smallgoods .sousuo').eq(1).stop().fadeOut(200)
})

$('.smallgoods img').eq(2).mouseenter(function(){
	$('.smallgoods .sousuo').eq(2).stop().fadeIn(200)

	$('.smallgoods .sousuo').eq(2).mouseenter(function(){
		$('.smallgoods .sousuo').eq(2).stop().show()
	})
})
$('.smallgoods img').eq(2).mouseleave(function(){
	$('.smallgoods .sousuo').eq(2).stop().fadeOut(200)
})

$('.smallgoods img').eq(3).mouseenter(function(){
	$('.smallgoods .sousuo').eq(3).stop().fadeIn(200)

	$('.smallgoods .sousuo').eq(3).mouseenter(function(){
		$('.smallgoods .sousuo').eq(3).stop().show()
	})
})
$('.smallgoods img').eq(3).mouseleave(function(){
	$('.smallgoods .sousuo').eq(3).stop().fadeOut(200)
})
